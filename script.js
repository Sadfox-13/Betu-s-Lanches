...
//funçao para adcionar no carrinho 
    ...
    cart.forEach(item => {
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="font-medium mt-2"><strong>R$ ${item.price.toFixed(2)} </strong></p>
            </div>   
...
//funçao paras remover o item do carrinho
